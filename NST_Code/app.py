...
# Set UPLOAD_FOLDER to an absolute path under the repository root so files saved
# by helper scripts or other modules are found regardless of working directory.
...
# Use workspace-relative paths for model files
base_dir = os.path.dirname(__file__)
